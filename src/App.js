...
class App extends Component {
  ...
  updateColor(e) {
    ...
    const { ctx, isErasing } = this.state;
  ...
  handleMouseMove(e) {
    ...
    const { ctx, lastX, lastY, isErasing } = this.state;
    const { offsetX, offsetY } = e.nativeEvent;
  ...
  render() {
    const { strokeStyle, inputSize, isErasing } = this.state;
    ...
    return (
      <div className="container">
        ...
        <form 
          ...
          <button
            type="button"
            className={`controls-input controls-eraser ${isErasing ? 'active' : ''}`}
